...
### Supplier Colours (bespoke — do not change)

Each supplier has a fixed colour used for their circle avatar, column colour bar, response tooltip header and type labels.

| Supplier | Hex |
|---|---|
| OEM Direct | `#337ab7` |
| Parts Network | `#9b59b6` |
| ATS Parts | `#e91e8c` |
| Eco Parts | `#16a34a` (Tailwind green-600 — aligns with brand green) |
| Reco Centre | `#f0ad4e` |
...
## 19. Price Cell Corner Indicators
...
## 20. Margin Rules — Insurer Mapping (Debtor Mapping)
...
## 21. Role-Based Access — Margin Settings
